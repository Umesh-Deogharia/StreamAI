...
function VideoTitle({ title, overview }) {
  return (
    <div className='pt-42 px-15 w-full aspect-video absolute bg-gradient-to-r from-black text-white '>
      <h1 className='text-xl -mt-33 md:mt-0 md:text-5xl font-bold w-1/4 '>{title}</h1> 
